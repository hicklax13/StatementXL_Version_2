...
import { login, setAuthToken, getGoogleAuthUrl, getErrorMessage } from '../api/client';
            ...
            <div className="w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-8 space-y-6">
                    ...
                    <button
                        ...
                        disabled={loading || googleLoading}
                        className="w-full py-3 bg-white border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                    >
                        {googleLoading ? (
                            <>
                                <Loader2 className="w-5 h-5 animate-spin" />
